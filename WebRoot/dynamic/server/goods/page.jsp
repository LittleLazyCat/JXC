	...
	<div id="tb">
		...
		<div>
			...
			&nbsp;商品类型：&nbsp;<input class="easyui-combobox" name="goods.s_type" id="s_type"
									data-options="panelHeight:'auto',editable:false,valueField:'value',textField:'value',url:'<%=basePath%>/server/dictionary!dictionaryComboList?name=商品类型'"/>	
				...
				<tr>
					...
					<td>
						...
						<input class="easyui-combobox" name="goods.typeId" id="typeId"
							data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'value',url:'<%=basePath%>/server/dictionary!dictionaryComboList?name=商品类型'"/>
					</td>
				</tr>
			</table>
		</form>
